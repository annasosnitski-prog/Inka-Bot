...
// сообщению клиента. Раньше клиент в waiting_slots/waiting_slots_pinged
// узнавал о свободном окне ТОЛЬКО если сам писал что-то ещё — тогда
// telegram.ts заново подтягивал слоты из календаря (см. lib/stateMachine.ts,
// п. 5b, isWaitingForSlots). Если клиент просто ждал молча, освободившееся
// окно оставалось непоказанным сколько угодно долго.
//
