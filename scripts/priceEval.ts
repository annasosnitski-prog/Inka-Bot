...
const cases: Case[] = [
  ...
  },
  {
    ...
    expected: '≈2400₪ за сеанс (клиенту НЕ называем сумму по всем сеансам)',
  },
  {
    ...
    expected: '≈2400₪ за сеанс (второй блок — тоже ≈2400₪/сеанс, НЕ суммируем в 4800₪ клиенту)',
  },
  {
    ...
    expected: '≈2500-3000₪ за сеанс (НЕ суммарная цена всего проекта)',
  },
  {
